...
function buildObviousMetaphorBans(article) {
    ...
    if (/\b(?:simulat(?:e|es|ed|ing|ion)|deployment|before release|model behavior before release)\b/i.test(text)) {
        bans.push('Deployment simulation / pre-release behavior stories: hard-ban simulation chambers, test chambers, quarantine booths, transparent boxes, transparent cages, public figures locked inside chambers, generic bouncers, red/velvet ropes, and access-card gatekeeping as the main joke. The viewer must understand "OpenAI crash-tests / stress-tests models before release" in 2 seconds. Prefer a brutal AI crash-test track, stress-test obstacle course, pre-release safety inspection, red-team drill, emergency drill, inspection table, or fake deployment disaster rehearsal. Sam Altman may act as the inspector holding a clipboard/remote while a blank black-box model/server unit is slammed through the test, engineers panic, and auditors watch under harsh flash.');
    }
